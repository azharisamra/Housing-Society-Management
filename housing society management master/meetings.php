                        ...
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    ...
                                    <li class="active"><a href="meetings.php">Meetings<span class="sr-only">(current)</a></li>
                ...
                <div class="row vol_area">
                    <div class="col-md-8">
                        <div class="volunteer_content" width="-50px" height="-50px">
                            <h3>Minutes of <span>Meetings </span></h3>
                            <p>Here is the detail of all the meeting taken place with the abstracts. </p>
                            <p>Click on the files to see the abstract of the meeting held on the respective date and time. </p>
                            ...
                            <div>
                                ...
                                <p>
                                    <?php
                                        error_reporting(0);
                                        $files = scandir('php/meetings');
                                        foreach($files as $file) 
                                        {
                                            if($file !== "." && $file !== "..") 
                                            {
                                                echo "<a href='php/meetings/$file'> ";
                                                echo $file; 
                                                echo "</a>";
                                                echo "<nobr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                                echo "This meeting was held on: " . date ("F d Y H:i:s.", filemtime($file));
                                                echo "</nobr> ";
