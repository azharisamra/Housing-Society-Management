        ...
        <section id="portfolio" class="text-center">
            <div class="col-md-12">
                <div class="portfolio_title">
                    <h2>Member Panel</h2>
                    <p>Here you can pay any amount(maintainence charge/ extra charge) to committee. Current way is Paytm.</p>
                    <h3> Use the below scan code to pay. </h3>
                    <img src="img/paytm-scratch.jpeg" height="500px" width="500px"></img>
                </div>
            </div>
            <!--End of col-md-2-->
        </section>
